...
def weekday():
    stringweek = strftime('%a')
    week.config(text=stringweek)
...
lb1 = Label(root, text="Timetable with alarm", font=("Helvetica 20 bold"), fg="red")
lb1.pack(pady=10)
lb2 = Label(root, text="Select mode", font=("Helvetica 15 bold"))
lb2.pack()
...
alb = Button(root, text="Load Weekly Timetable", font=("Helvetica 15"), command=lambda: [Threading(), alb.pack_forget(), lb1.pack_forget(), lb2.pack_forget(), alb2.pack_forget()],  )
alb.pack(pady=20,)

alb2 = Button(root, text="Load Daily Timetable", font=("Helvetica 15"), command=lambda: [Threadday(), alb.pack_forget(), lb1.pack_forget(), lb2.pack_forget(), alb2.pack_forget()],  )
alb2.pack(pady=20,)
...
def timetable():
  ...
  les.grid(row=4, column=3,)
  lun.grid(row=7, column=3, )
...
def dayiltable():
    ...
    Label(root, text="0", padx=10).grid(row=1, column=0)
    Label(root, text="1", padx=10).grid(row=2, column=0)
    Label(root, text="2", padx=10).grid(row=3, column=0)
    Label(root, text="3", padx=10).grid(row=5, column=0)
    Label(root, text="4", padx=10).grid(row=6, column=0)
    Label(root, text="5", padx=10).grid(row=8, column=0)
    Label(root, text="6", padx=10).grid(row=9, column=0)
    ...
    les.grid(row=4, column=1, )
    lun.grid(row=7, column=1, )

    weekday()
    week.grid(row=0, column=1)

    timed()
    lbl.grid(row=10, column=1)
    root.minsize(125, 375)
